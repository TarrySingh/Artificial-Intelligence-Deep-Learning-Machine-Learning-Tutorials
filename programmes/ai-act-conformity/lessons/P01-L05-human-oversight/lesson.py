...
# [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/TarrySingh/Artificial-Intelligence-Deep-Learning-Machine-Learning-Tutorials/blob/main/atlas/programmes/ai-act-conformity/lessons/P01-L05-human-oversight/lesson.ipynb)
# [![Open in Kaggle](https://kaggle.com/static/images/open-in-kaggle.svg)](https://kaggle.com/kernels/welcome?src=https://github.com/TarrySingh/Artificial-Intelligence-Deep-Learning-Machine-Learning-Tutorials/blob/main/atlas/programmes/ai-act-conformity/lessons/P01-L05-human-oversight/lesson.ipynb)
# [![Open in Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/TarrySingh/Artificial-Intelligence-Deep-Learning-Machine-Learning-Tutorials/main?labpath=atlas/programmes/ai-act-conformity/lessons/P01-L05-human-oversight/lesson.ipynb)
...
ATLAS_RAW = os.environ.get("ATLAS_RAW_OVERRIDE") or "https://raw.githubusercontent.com/TarrySingh/Artificial-Intelligence-Deep-Learning-Machine-Learning-Tutorials/main/atlas/programmes/ai-act-conformity/lessons/P01-L05-human-oversight/"
...
# 4. Implement the Article 14(5) four-eyes check as a count of **distinct natural persons**.
# 5. Implement an automation-bias curve and separate a reviewer whose override rate collapses
#    to nothing from one whose rate merely declines, using each reviewer's own detectable floor.
# 6. Implement `oversight_gate()` and report the decisions it would have blocked.
#
