...
# [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/TarrySingh/Artificial-Intelligence-Deep-Learning-Machine-Learning-Tutorials/blob/main/atlas/programmes/predictive-maintenance/lessons/P03-L05-remaining-useful-life/lesson.ipynb)
# [![Open in Kaggle](https://kaggle.com/static/images/open-in-kaggle.svg)](https://kaggle.com/kernels/welcome?src=https://github.com/TarrySingh/Artificial-Intelligence-Deep-Learning-Machine-Learning-Tutorials/blob/main/atlas/programmes/predictive-maintenance/lessons/P03-L05-remaining-useful-life/lesson.ipynb)
# [![Open in Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/TarrySingh/Artificial-Intelligence-Deep-Learning-Machine-Learning-Tutorials/main?labpath=atlas/programmes/predictive-maintenance/lessons/P03-L05-remaining-useful-life/lesson.ipynb)
...
ATLAS_RAW = os.environ.get("ATLAS_RAW_OVERRIDE") or "https://raw.githubusercontent.com/TarrySingh/Artificial-Intelligence-Deep-Learning-Machine-Learning-Tutorials/main/atlas/programmes/predictive-maintenance/lessons/P03-L05-remaining-useful-life/"
...
#
# 1. Implement a Bayesian fit of an exponential degradation model and explain why the
#    posterior over its two parameters, not the fitted line, is the thing you predict from.
# 2. Implement a Monte-Carlo predictive distribution for remaining useful life, and measure
#    how far its interval narrows between a third of life and the last fifth.
# 3. Implement three prognostic metrics — RMSE, the asymmetric C-MAPSS score, and the
#    alpha-lambda accuracy cone — and the warning lead time a maintenance contract requires.
# 4. Measure which quantile of your own predictive distribution each metric selects, and
#    explain why two of the four disagree with the other two.
# 5. Demonstrate, from your own numbers, that RMSE-on-RUL prefers a model that arrives late.
#
