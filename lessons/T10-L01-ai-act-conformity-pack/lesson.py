...
#
# This lesson needs Python 3.11 or newer. The cell below installs `pyyaml==6.0.3` and fetches
...
# reasoning for each comes with this lesson's worked solution when you enrol on Synapsa.
